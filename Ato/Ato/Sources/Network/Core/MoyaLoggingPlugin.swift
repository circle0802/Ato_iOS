...
public final class MoyaLoggingPlugin: PluginType {
    ...
    nonisolated func onSuceed(_ response: Response, target: TargetType, isFromError: Bool) {
    ...
    nonisolated func onFail(_ error: MoyaError, target: TargetType) {
...
typealias MoyaLogginPlugin = MoyaLoggingPlugin
